...
var init = () => {
...

    {
        ...
        c2Exp.description = Localization.getUpgradeIncCustomExpDesc("c_2", "1e100");
        c2Exp.info = Localization.getUpgradeIncCustomExpInfo("c_2", "1e100");
...
var getPublicationMultiplier = (tau) => tau.pow(0.962) / BigNumber.THREE;
